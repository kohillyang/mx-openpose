...
def parse_heatpaf_py(oriImg, heatmap_avg, paf_avg, limbSeq, image_id=0, category_id=1, fscale=1.0):
    param = dict()
    param['thre1'] = 0.1
    param['thre2'] = 0.05
    all_peaks = []
...
def parse_heatpaf_py_coco(oriImg, heatmap_avg, paf_avg, limbSeq, image_id=0, category_id=1, fscale=1.0):
    param = dict()
    param['thre1'] = 0.1
    param['thre2'] = 0.05
    all_peaks = []
